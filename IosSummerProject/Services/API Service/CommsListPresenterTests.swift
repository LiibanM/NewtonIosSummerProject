...
class CommsListPresenterTests: XCTestCase {
    ...
    var mockCommsListPreseterDelegate: MockCommsListPresenterDelegate!
    var mockCommsListPresenterView: MockCommsListPreseneterView!


    override func setUpWithError() throws {
        mockApiService = MockApiService()
        mockCommsListPreseterDelegate = MockCommsListPresenterDelegate()
        mockCommsListPresenterView = MockCommsListPreseneterView()
        commsListPresenter = CommsListPresenter(with: mockCommsListPresenterView, delegate: mockCommsListPreseterDelegate, mockApiService)
    }

    override func tearDownWithError() throws {
        commsListPresenter = nil
        mockApiService = nil
        mockCommsListPreseterDelegate = nil
